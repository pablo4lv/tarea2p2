...
ENTREGAR = visitante pieza coleccionPiezas grupoABB coleccionTGrupos
...
CASOS = pieza1-crear-liberar \
		...
		coleccionTGrupos4-removerultimo-removerenesimo \
